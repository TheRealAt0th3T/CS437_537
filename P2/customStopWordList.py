...
# This list can be reviewed as we are implementing the project. **KEEP THIS IN MIND**
# This list affects what will be outputted(results) from our query search.
custom_stopword_list = {'able', 'about', 'above', 'abroad', 'according', 'accordingly', 'across', 'actually', 'adj',
                        ...
                        'are', 'aren', 't', 'around', 'as', 'a', 's', 'aside', 'ask', 'asking', 'associated', 'at',
                        'available', 'away', 'awfully', 'back', 'backward', 'backwards', 'be', 'became', 'because',
                        'become', 'becomes', 'becoming', 'been', 'before', 'beforehand', 'begin', 'behind', 'being',
                        'believe', 'below', 'beside', 'besides', 'best', 'better', 'between', 'beyond', 'both', 'brief',
                        'but', 'by', 'came', 'can', 'can', 'not', 'cant', 'can', 't', 'caption', 'cause', 'causes',
                        ...
                        'greetings', 'had', 'hadn', 't', 'half', 'happens', 'hardly', 'has', 'hasn', 't', 'have',
                        ...
                        'd', 'ie', 'if', 'ignored', 'i', 'll', 'i', 'm', 'immediate', 'in', 'inasmuch', 'inc', 'inc',
                        'indeed', 'indicate', 'indicated', 'indicates', 'inner', 'inside', 'insofar', 'instead', 'into',
                        'inward', 'is', 'isn', 't', 'it', 'it', 'd', 'it', 'll', 'its', 'it', 's', 'itself', 'i', 've',
                        'just', 'k', 'keep', 'keeps', 'kept', 'know', 'known', 'knows', 'last', 'lately', 'later',
                        'latter', 'latterly', 'least', 'less', 'lest', 'let', 'let', 's', 'like', 'liked', 'likely',
                        'likewise', 'little', 'look', 'looking', 'looks', 'low', 'lower', 'ltd', 'made', 'mainly',
                        'make', 'makes', 'many', 'may', 'maybe', 'mayn', 't', 'me', 'mean', 'meantime', 'meanwhile',
                        'merely', 'might', 'mightn', 't', 'mine', 'minus', 'miss', 'more', 'moreover', 'most', 'mostly',
                        'mr', 'mrs', 'much', 'must', 'mustn', 't', 'my', 'myself', 'name', 'namely', 'nd', 'near',
                        ...
                        'selves', 'sensible', 'sent', 'serious', 'seriously', 'seven', 'several', 'shall', 'shan', 't',
                        ...
                        'theirs', 'them', 'themselves', 'then', 'thence', 'there', 'thereafter', 'thereby', 'there',
                        'd', 'therefore', 'therein', 'there', 'll', 'there', 're', 'theres', 'there', 's', 'thereupon',
                        ...
                        'value', 'various', 'versus', 'very', 'via', 'viz', 'vs', 'want', 'wants', 'was', 'wasn', 't',
                        'way', 'we', 'we', 'd', 'welcome', 'well', 'we', 'll', 'went', 'were', 'we', 're', 'weren', 't',
                        'we', 've', 'what', 'whatever', 'what', 'll', 'what', 's', 'what', 've', 'when', 'whence',
                        'whenever', 'where', 'whereafter', 'whereas', 'whereby', 'wherein', 'where', 's', 'whereupon',
                        ...
                        'yourselves', 'you', 've', 'zero', 'a', 'how', 's', 'i', 'when', 's', 'why', 's', 'b', 'c', 'd',
                        'e', 'f', 'g', 'h', 'j', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'uucp', 'w', 'x',
                        'y', 'z', 'I', 'www', 'amount', 'bill', 'bottom', 'call', 'computer', 'con', 'couldnt', 'cry',
                        'de', 'describe', 'detail', 'due', 'eleven', 'empty', 'fifteen', 'fifty', 'fill', 'find',
                        'fire', 'forty', 'front', 'full', 'give', 'hasnt', 'herse', 'himse', 'interest', 'itse', '”',
                        'mill', 'move', 'myse', '”', 'part', 'put', 'show', 'side', 'sincere', 'sixty', 'system', 'ten',
                        'thick', 'thin', 'top', 'twelve', 'twenty', 'abst', 'accordance', 'act', 'added', 'adopted',
                        'affected', 'affecting', 'affects', 'ah', 'announce', 'anymore', 'apparently', 'approximately',
                        'aren', 'arent', 'arise', 'auth', 'beginning', 'beginnings', 'begins', 'biol', 'briefly', 'ca',
                        'date', 'ed', 'effect', 'et', 'al', 'ff', 'fix', 'gave', 'giving', 'heres', 'hes', 'hid',
                        ...
                        'omitted', 'ord', 'owing', 'page', 'pages', 'poorly', 'possibly', 'potentially', 'pp',
                        'predominantly', 'present', 'previously', 'primarily', 'promptly', 'proud', 'quickly', 'ran',
                        'readily', 'ref', 'refs', 'related', 'research', 'resulted', 'resulting', 'results', 'run',
                        'sec', 'section', 'shed', 'shes', 'showed', 'shown', 'showns', 'shows', 'significant',
                        'significantly', 'similar', 'similarly', 'slightly', 'somethan', 'specifically', 'state',
                        'states', 'stop', 'strongly', 'substantially', 'successfully', 'sufficiently', 'suggest',
                        'thered', 'thereof', 'therere', 'thereto', 'theyd', 'theyre', 'thou', 'thoughh', 'thousand',
                        'throug', 'til', 'tip', 'ts', 'ups', 'usefully', 'usefulness', 've', 'vol', 'vols', 'wed',
                        'whats', 'wheres', 'whim', 'whod', 'whos', 'widely', 'words', 'world', 'youd', 'youre'}


# Return the custom list
def get_custom_sw_list():
    return custom_stopword_list

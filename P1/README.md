...
* Team Members: Alejandro Macias, Amara Tariq, and Hongmin (Steven) Kim
...
## Tables for required sections

Inserted here will be the tables that Pera wants us to fill out for certain subsections
